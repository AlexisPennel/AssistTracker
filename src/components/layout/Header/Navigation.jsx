...
import homeMenu from '../../../../public/images/menu/home.jpg'
...
export function Navigation() {
  ...
  return (
    <NavigationMenu className={'z-50 hidden xl:block'} viewport={isMobile}>
            ...
            <ul className="grid gap-2 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
              <li className="row-span-3">
                <NavigationMenuLink asChild>
                  <Link
                    href="/"
                    className="from-muted/50 to-muted relative flex h-full w-full flex-col justify-end overflow-hidden rounded-md bg-linear-to-b p-3 no-underline outline-hidden transition-all duration-200 select-none focus:shadow-md md:p-2"
                  >
                    <Image
                      src={homeMenu}
                      fill
                      className="inset-0 z-1 object-cover"
                      alt="cover home"
                    />
                    <div className="z-2">
                      <div className="text-primary-foreground mb-1 text-lg font-semibold sm:mt-4">
                        Home
                      </div>
                      <p className="text-primary-foreground max-w-[80%] text-sm leading-tight">
